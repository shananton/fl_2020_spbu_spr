...
Имя состоит из латинских букв, цифр и `_`, где первый символ - не цифра.
...
Определять функции с одним именем допустимо лишь тогда, когда у них различное число аргументов.
